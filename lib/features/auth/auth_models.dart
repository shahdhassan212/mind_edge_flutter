...
//
// All request bodies and response payloads for the auth layer.
// Using plain Dart classes with toJson/fromJson.
// No code generation needed — keeps setup zero-dependency.
// ============================================================
...
class AuthResponse {
  ...
  factory AuthResponse.fromJson(Map<String, dynamic> json) {
    // Backend may return user nested or flat at root level
