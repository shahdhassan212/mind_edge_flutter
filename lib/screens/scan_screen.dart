// ============================================================
// Page 12 — Scan Document (dark camera UI)
// ============================================================
        ...
        child: SafeArea(
          child: Column(children: [
            ...
            Padding(
              ...
              child: Row(children: [
                _DarkNavBtn(child: const Text('←', style: TextStyle(fontSize: 16,
                  color: AppColors.goldLight))),
                const Spacer(),
                const Text('Scan Document',
                  style: TextStyle(fontFamily: 'Syne', fontSize: 14, fontWeight: FontWeight.w600,
                    color: Color(0xFFD9CCB5))),
                const Spacer(),
                _DarkNavBtn(child: const Text('⚡', style: TextStyle(fontSize: 12,
                  ...
                  child: Stack(children: [
                    ...
                    Container(decoration: const BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [Color(0xFF1C1206), Color(0xFF241608), Color(0xFF1A1005)]))),
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (_, __) {
                        ...
                        return Positioned(
                          top: y, left: 14, right: 14, height: 2,
                          child: Opacity(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [Colors.transparent,
                                    AppColors.gold.withOpacity(0.8), Colors.transparent])),
                            ),
                          ),
                        );
                      },
                    ...
                    Positioned(top: 10, right: 10,
                      child: Container(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          const Text('OCR Active',
                            style: TextStyle(fontFamily: 'DM Sans', fontSize: 10,
                              fontWeight: FontWeight.w600, color: AppColors.goldLight,
                        ...
                        child: Row(children: [
                          Text('Detection confidence',
                            style: TextStyle(fontFamily: 'DM Sans', fontSize: 11,
                              color: AppColors.white.withOpacity(0.7), fontWeight: FontWeight.w300)),
                          const Spacer(),
                          const Text('98.4%',
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Row(children: ['Camera', 'Gallery', 'PDF / File'].asMap().map((i, label) {
                  final on = i == _tab;
                  return MapEntry(i, Expanded(child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Text(label, textAlign: TextAlign.center,
                        style: TextStyle(fontFamily: 'DM Sans', fontSize: 11,
                          ...
                          color: on ? AppColors.goldLight : AppColors.white.withOpacity(0.4))),
                    ),
                  )));
                }).values.toList()),
              ),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              _CamControl(icon: '🔦', label: 'Flash', onTap: () {}),
              const SizedBox(width: 20),
              // Shutter
              GestureDetector(
                onTap: () => Navigator.pushNamed(context, '/ocr-processing'),
                child: Container(
                  width: 68, height: 68,
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      ...
                      BoxShadow(color: Colors.white.withOpacity(0.06), blurRadius: 0, spreadRadius: 8),
                    ],
                  ),
              ...
              const SizedBox(width: 20),
              _CamControl(icon: '⇄', label: 'Flip', onTap: () {}),
            ]),
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('AI Analyzing Document',
                      style: TextStyle(fontFamily: 'DM Sans', fontSize: 12.5,
                        fontWeight: FontWeight.w600, color: AppColors.white.withOpacity(0.85))),
                    const SizedBox(height: 2),
                    Text('Extracting text, structure, and topics…',
                      style: TextStyle(fontFamily: 'DM Sans', fontSize: 10.5,
                        color: AppColors.white.withOpacity(0.4), fontWeight: FontWeight.w300)),
            ...
            Text('Hold camera steady · Multi-page supported',
              ...
              style: TextStyle(fontFamily: 'DM Sans', fontSize: 11,
                color: AppColors.white.withOpacity(0.3), fontWeight: FontWeight.w300)),
          ]),
        ),
      ),
    );
...
class _Corner extends StatelessWidget {
  ...
  final Color color;
  const _Corner({this.tl=false,this.tr=false,this.bl=false,this.br=false,required this.color});
  @override
...
class _CornerPainter extends CustomPainter {
  final bool tl,tr,bl,br;
  final Color color;
  const _CornerPainter({required this.tl,required this.tr,required this.bl,
    required this.br,required this.color});
  @override
  void paint(Canvas c, Size s) {
    final p = Paint()..color=color..strokeWidth=2..style=PaintingStyle.stroke
      ..strokeCap=StrokeCap.square;
    if (tl) { c.drawLine(Offset(0,s.height*.5), Offset(0,4),p);
      c.drawArc(Rect.fromLTWH(0,0,8,8),-3.14/2,3.14/2,false,p);
      c.drawLine(Offset(4,0),Offset(s.width*.5,0),p); }
    if (tr) { c.drawLine(Offset(s.width*.5,0), Offset(s.width-4,0),p);
      c.drawArc(Rect.fromLTWH(s.width-8,0,8,8),0,-3.14/2,false,p);
      c.drawLine(Offset(s.width,4),Offset(s.width,s.height*.5),p); }
    if (bl) { c.drawLine(Offset(0,s.height*.5),Offset(0,s.height-4),p);
      c.drawArc(Rect.fromLTWH(0,s.height-8,8,8),3.14/2,3.14/2,false,p);
      c.drawLine(Offset(4,s.height),Offset(s.width*.5,s.height),p); }
    if (br) { c.drawLine(Offset(s.width*.5,s.height),Offset(s.width-4,s.height),p);
...
class _CamControl extends StatelessWidget {
  ...
  const _CamControl({required this.icon, required this.label, required this.onTap});
  @override
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Column(children: [
      ...
      Text(label, style: TextStyle(fontFamily: 'DM Sans', fontSize: 10.5,
    ...
    child: FractionallySizedBox(
      ...
      child: ClipRRect(
        ...
        child: Stack(children: [
          ...
          ShimmerOverlay(duration: const Duration(milliseconds: 1600),
            delay: Duration.zero, shimmerOpacity: 0.4),
        ]),
      ),
    ),
  );
...
class _PulsingDotState extends State<_PulsingDot>
  ...
  @override Widget build(BuildContext context) => AnimatedBuilder(
    animation: _c,
    builder: (_,__) => Opacity(opacity: 0.6 + _c.value * 0.4,
