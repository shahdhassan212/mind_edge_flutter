// ============================================================
// Page 15 — Study Plan Generator (dynamic)
// ============================================================
import 'dart:io';
...
class _StudyPlanScreenState extends ConsumerState<StudyPlanScreen> {
  ...
  // Uploaded file state
  String? _uploadedFileName; // display name shown in UI
  ...
  // ── Generate (static for now — endpoint coming) ────────
  void _generate() {
    // TODO: call study-plan endpoint when ready
    // Payload will be:
    // {
    //   "subject":    _subjectCtrl.text,
    //   "days":       int.tryParse(_daysCtrl.text) ?? 30,
    //   "dailyHours": ['1', '2', '3+'][_daily],
    //   "difficulty": _diff == 0 ? 'Beginner' : 'Advanced',
    //   "fileName":   _uploadedFileName,   // nullable
    // }
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(26, 12, 26, 0),
                      child: Column(children: [
                        // Days input (replaces duration selector)
                        ...
                        child: Container(
                          ...
                          child: _DashedBorder(
                            color: _uploadSuccess
                                ...
                                : const Color(0xFFB48C50).withOpacity(0.3),
                            borderRadius: 18,
                            child: Padding(
                              padding: const EdgeInsets.all(18),
                              child: Row(children: [
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(
                                              ...
                                              fontSize: 10.5,
                                              color:
                                                  _uploadSuccess ? AppColors.gold : AppColors.muted,
                                ...
                                if (!isUploading)
                                  Text(
                                    _uploadedFileName != null ? 'Change' : 'Add ＋',
                                    style: const TextStyle(
                                        fontFamily: 'DM Sans',
                                        fontSize: 11,
                                        fontWeight: FontWeight.w600,
...
// ─────────────────────────────────────────────────────────────
// DAYS INPUT — replaces the old duration selector
// ─────────────────────────────────────────────────────────────
